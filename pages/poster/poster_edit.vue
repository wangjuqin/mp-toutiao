<template>
	<view class="content">
		...
		<form @submit="formSubmit" @reset="formReset" class="box-form" style="width: 95%;margin-top: 30rpx;">
			<view class="house-dt" > <!-- :style="'background-image':posterdata.image" -->
				...
				<view class="house">
					<view class="housename">
						<input type="text" value="" name="name" placeholder="请输入楼盘或房源名称" />
					</view>
					...
					<view class="ppt-input">
						<input type="text" value="" name="price" placeholder="售价" />
						<input type="text" value="" name="area" placeholder="面积" />
						<input type="text" value="" name="house" placeholder="户型" />
					</view>
			...
			<view class="users">
				<view class="user-lf">
					<view class="uname">
						联系人:<input type="text" value="" name="username" placeholder="联系人" />
					</view>
					<view class="uname utel">
						联系电话:<input type="text" value="" name="phone" placeholder="联系电话" />
					</view>
				</view>


				<image v-if="posterdata.wecaht_img" :src="utils.siteBaseUrl(posterdata.wecaht_img)" mode=""></image>
				<input type="text" :value="posterdata.wecaht_img" name="wecaht_img" hidden />

			</view>

			<view class="fielx-box">
				<button class="rt-list">返回列表页</button>

				<button class="view" form-type="submit">预览</button>
